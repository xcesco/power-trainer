...
public class Exercise implements Serializable {
    ...
    public Set<ExerciseResource> getExerciseResources() {
        return this.exerciseResources;
    }

    public Exercise exerciseResources(Set<ExerciseResource> exerciseResources) {
        this.setExerciseResources(exerciseResources);
        return this;
    }

    public Exercise addExerciseResource(ExerciseResource exerciseResource) {
        this.exerciseResources.add(exerciseResource);
        exerciseResource.setExercise(this);
        return this;
    }

    public Exercise removeExerciseResource(ExerciseResource exerciseResource) {
        this.exerciseResources.remove(exerciseResource);
        exerciseResource.setExercise(null);
        return this;
    }

    public void setExerciseResources(Set<ExerciseResource> exerciseResources) {
        if (this.exerciseResources != null) {
            this.exerciseResources.forEach(i -> i.setExercise(null));
        }
        if (exerciseResources != null) {
            exerciseResources.forEach(i -> i.setExercise(this));
        }
        this.exerciseResources = exerciseResources;
    }
