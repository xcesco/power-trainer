...
public class TranslationResource {
    ...
    public ResponseEntity<List<TranslationDTO>> getAllTranslations(TranslationCriteria criteria, Pageable pageable) {
        log.debug("REST request to get Translations by criteria: {}", criteria);
        Page<TranslationDTO> page = translationQueryService.findByCriteria(criteria, pageable);
