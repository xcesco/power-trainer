...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.abubusoft.powertrainer.domain.Exercise.class.getName() + ".exerciseResources");
            ...
            createCache(cm, com.abubusoft.powertrainer.domain.ExerciseResource.class.getName());
