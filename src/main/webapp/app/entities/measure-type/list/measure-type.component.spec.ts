...
describe('Component Tests', () => {
  describe('MeasureType Management Component', () => {
    let comp: MeasureTypeComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(MeasureTypeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.measureTypes?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
