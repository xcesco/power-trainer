...
describe('Component Tests', () => {
  describe('WorkoutSheet Management Component', () => {
    let comp: WorkoutSheetComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(WorkoutSheetComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.workoutSheets?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
